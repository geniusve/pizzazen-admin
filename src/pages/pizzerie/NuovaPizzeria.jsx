  ...
  return (
    <div className="p-8 max-w-2xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-500 text-sm mt-1">Compila i dati per registrare una nuova pizzeria nel sistema</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Section title="Account admin pizzeria" icon="🔑">
          <p className="text-gray-500 text-sm mb-4">Credenziali che il titolare userà per accedere al pannello</p>
          <div className="grid grid-cols-2 gap-4">
